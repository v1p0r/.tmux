...
```
curl -fsSL "https://github.com/v1p0r/.tmux/raw/refs/heads/master/install.sh#$(date +%s)" | bash
```

**Manual installation in `~`**
```sh
cd
git clone --single-branch https://github.com/v1p0r/.tmux.git
...
```sh
git clone --single-branch https://github.com/v1p0r/.tmux.git "/path/to/oh-my-tmux"
